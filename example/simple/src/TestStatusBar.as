...
package
{
	...
	/**	
	 * Sample application for using the StatusBar Native Extension
	 */
	public class TestStatusBar extends Sprite
	{
		...
		private function init( ):void
		{
			try
			{
				message( "StatusBar Supported: " + StatusBar.isSupported );
				message( "StatusBar Version:   " + StatusBar.service.version );
